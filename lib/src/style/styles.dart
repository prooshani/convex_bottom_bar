...
DelegateBuilder supportedStyle(
  ...
  assert(
      ((style == TabStyle.fixed || style == TabStyle.fixedCircle) && items.length.isOdd) ||
  ...
  switch (style) {
    ...
    case TabStyle.textIn:
      assert(items.every((it) => it.title != null && it.title != Text('')), 'title is necessary for TabStyle.textIn');
    ...
    case TabStyle.titled:
      assert(items.every((it) => it.title != null && it.title != Text('')), 'title is necessary for TabStyle.titled');
